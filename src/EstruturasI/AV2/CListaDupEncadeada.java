...
public class CListaDupEncadeada implements ILista {

    private NoDup sentinela;
    private int totalElementos;

    public CListaDupEncadeada(){
        this.sentinela = new NoDup();
    ...
    public void remover(Comparable chave) throws ListaException {
        ...
        NoDup atual = this.sentinela.getProximo();
    ...
    public void removerDuplicados() throws ListaException{
        if (!estaVazia()){
            NoDup atual1 = this.sentinela.getProximo();
            while (atual1!=sentinela){
                NoDup atual2 = atual1.getProximo();
                while (atual2 !=sentinela){
    ...
    public String toString() {
        ...
        NoDup atual = sentinela.getProximo();
        while (atual != sentinela){
